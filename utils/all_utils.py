...
def prepare_data(df):
  ...
  Returns:
    tuple: It returns tuples of dependent variables and independent variables
  """

  logging.info("Preparing the data by segregating dependent variables and independent variable")
  X = df.drop("y", axis=1)
